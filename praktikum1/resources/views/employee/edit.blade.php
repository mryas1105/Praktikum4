...
<body>
    ...
    <div class="container mt-4">
        <h4>Edit Employee - {{ $employee->firstname }} {{ $employee->lastname }}</h4>
        <hr>
        <form action="{{ route('employees.', ['employee' => $employee->employee_id]) }}" method="POST">
            @csrf
            @method('put')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="position" name="position" value="{{ $employee->position_name }}">
            </div>
